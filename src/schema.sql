...
(
    ...
    email TEXT NOT NULL UNIQUE CHECK (email LIKE '%_@__%.__%'),
    phone_number TEXT NOT NULL UNIQUE CHECK (phone_number GLOB '07[0-9][0-9][0-9][ ][0-9][0-9][0-9][0-9][0-9][0-9]'),
    ...
    emergency_contact_phone TEXT NOT NULL DEFAULT 'Unknown' CHECK (phone_number GLOB '07[0-9][0-9][0-9][ ][0-9][0-9][0-9][0-9][0-9][0-9]')
);
...
(
    ...
    email TEXT NOT NULL UNIQUE CHECK (email LIKE '%_@__%.__%'),
    phone_number TEXT NOT NULL UNIQUE CHECK (phone_number GLOB '07[0-9][0-9][0-9][ ][0-9][0-9][0-9][0-9][0-9][0-9]'),
    position TEXT NOT NULL CHECK (position in ('Manager','Trainer','Receptionist')),
    hire_date TEXT NOT NULL CHECK(hire_date GLOB '[0-9][0-9][0-9][0-9][-][0-9][0-9][-][0-9][0-9]'),
    location_id INTEGER, FOREIGN KEY (location_id) REFERENCES locations(location_id)
);
...
(
    ...
    next_maintenance_date TEXT NOT NULL CHECK(next_maintenance_date GLOB '[0-9][0-9][0-9][0-9][-][0-9][0-9][-][0-9][0-9]'),
    location_id INTEGER, FOREIGN KEY (location_id) REFERENCES locations(location_id)
);
...
(
    ...
    class_id INTEGER, 
    staff_id INTEGER, 
    start_time TEXT NOT NULL CHECK(start_time GLOB '[0-9][0-9][0-9][0-9][-][0-9][0-9][-][0-9][0-9][ ][0-9][0-9][:][0-9][0-9][:][0-9][0-9]'),
    end_time TEXT NOT NULL CHECK(end_time GLOB '[0-9][0-9][0-9][0-9][-][0-9][0-9][-][0-9][0-9][ ][0-9][0-9][:][0-9][0-9][:][0-9][0-9]'),
...
(
    ...
    member_id INTEGER, 
    location_id INTEGER,
    check_in_time TEXT NOT NULL CHECK(check_in_time GLOB '[0-9][0-9][0-9][0-9][-][0-9][0-9][-][0-9][0-9][ ][0-9][0-9][:][0-9][0-9][:][0-9][0-9]'),
    check_out_time TEXT CHECK(check_out_time GLOB '[0-9][0-9][0-9][0-9][-][0-9][0-9][-][0-9][0-9][ ][0-9][0-9][:][0-9][0-9][:][0-9][0-9]'),
    FOREIGN KEY (member_id) REFERENCES member(member_id),
...
(
    ...
    member_id INTEGER,
    amount REAL,
    payment_date TEXT NOT NULL CHECK(payment_date GLOB '[0-9][0-9][0-9][0-9][-][0-9][0-9][-][0-9][0-9][ ][0-9][0-9][:][0-9][0-9][:][0-9][0-9]'),
    payment_method TEXT NOT NULL CHECK (payment_method in ('Credit Card','PayPal', 'Cash', 'Bank Transfer')),
...
(
    ...
    start_time TEXT NOT NULL CHECK(start_time GLOB '[0-9][0-9][:][0-9][0-9][:][0-9][0-9]'), 
    end_time TEXT NOT NULL CHECK(end_time GLOB '[0-9][0-9][:][0-9][0-9][:][0-9][0-9]'), 
    notes TEXT NOT NULL CHECK (notes in ('Cardio focus', 'Strength training', 'Form check')),
    FOREIGN KEY (member_id) REFERENCES member(member_id)
    FOREIGN KEY (staff_id) REFERENCES staff(staff_id)
);
...
(
    ...
    member_id INTEGER,
    measurement_date TEXT NOT NULL CHECK(measurement_date GLOB '[0-9][0-9][0-9][0-9][-][0-9][0-9][-][0-9][0-9]'),
    weight REAL,
...
(
    ...
    maintenance_date TEXT NOT NULL CHECK(maintenance_date GLOB '[0-9][0-9][0-9][0-9][-][0-9][0-9][-][0-9][0-9]'),
    description TEXT NOT NULL,
    staff_id INTEGER,
